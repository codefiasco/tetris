...
public class JBlock extends Block{
    ...
    private void spinSideways() {
        ...
        if (!positions[0].movePermission(positions[0].getCol(), positions[0].getRow() + 2 * factor) ||
                ...
                !positions[3].movePermission(positions[3].getCol() + 3 * factor, positions[3].getRow() + factor)) {
            return;
        }
        ...
        positions[3].clear();
        positions[3].moveTo(positions[3].getCol() + 3 * factor, positions[3].getRow() + factor);
        representations[3].translate(Constants.CELL_SIZE * 3 * factor, Constants.CELL_SIZE * factor);
